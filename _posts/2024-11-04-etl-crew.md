...
<div style="position: relative; width: 100%; padding-bottom: 56.25%; height: 0; overflow: hidden;">
  {% include video.liquid path="https://www.youtube.com/embed/5Vb4oDTf8Gg" class="img-fluid rounded z-depth-1" width="100%" height="100%" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" %}
</div>
